...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "usage.description": "Daily and monthly token consumption across all pi sessions, computed from your local session files.",
    "usage.refresh": "Refresh",
    "usage.refreshing": "Refreshing…",
    "usage.loadError": "Failed to load usage data: {error}",
    "usage.noData": "No usage data yet — start a conversation first.",
    "usage.today": "Today",
    "usage.thisMonth": "This month",
    "usage.allTime": "All time",
    "usage.cardSub": "{cost} · {requests} requests",
    "usage.tokens": "tokens",
    "usage.dailyActivity": "Daily activity",
    "usage.dailyActivityDescription": "One cell per day over the last year. Click a day for its per-model breakdown.",
    "usage.legendLess": "Less",
    "usage.legendMore": "More",
    "usage.daySummary": "{tokens} tokens · {cost} · {requests} requests",
    ...
    "usage.cache": "Cache",
    "usage.cost": "Cost",
    "usage.footnote": "Aggregated from {sessions} session files. Usage from deleted sessions is kept, so totals never decrease. Cost reflects provider pricing recorded in session data; models without pricing show $0.",
    ...
    "sidebar.removeFromFolder": "Remove from folder (use workspace)",
    "sidebar.deleteFolder": "Delete folder",
    "sidebar.archive": "Archive session",
    "sidebar.unarchive": "Unarchive session",
    "sidebar.archivedCount": "Archived ({count})",
    "sidebar.hideWorkspace": "Hide workspace from list",
    "sidebar.unhideWorkspace": "Unhide workspace",
    "sidebar.hiddenWorkspaces": "Hidden Workspaces ({count})",
    "sidebar.cannotHideCurrent": "Current active workspace cannot be hidden",
    ...
    "chat.stop": "Stop",
    "chat.disableSound": "Disable completion sound & notifications",
    "chat.enableSound": "Enable completion sound & notifications",
    "chat.enableNotifications": "Enable desktop notifications",
    "chat.disableNotifications": "Desktop notifications enabled (click to send test)",
    "chat.notificationsBlocked": "Notifications blocked by browser, please allow in site settings",
    "chat.notificationTestTitle": "pi-web desktop notifications ready",
    "chat.notificationTestBody": "You will be notified when tasks finish or need input",
