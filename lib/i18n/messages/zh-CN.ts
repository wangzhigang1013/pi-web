...
export const zhCNLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "usage.description": "按天和按月统计所有 pi 会话的 Token 消耗，数据来自本地会话文件。",
    "usage.refresh": "刷新",
    "usage.refreshing": "刷新中…",
    "usage.loadError": "加载用量数据失败：{error}",
    "usage.noData": "暂无用量数据——先开始一段对话吧。",
    "usage.today": "今天",
    "usage.thisMonth": "本月",
    "usage.allTime": "累计",
    "usage.cardSub": "{cost} · {requests} 次请求",
    "usage.tokens": "tokens",
    "usage.dailyActivity": "每日用量",
    "usage.dailyActivityDescription": "过去一年每天一格，点击某天可查看按模型拆分的明细。",
    "usage.legendLess": "少",
    "usage.legendMore": "多",
    "usage.daySummary": "{tokens} tokens · {cost} · {requests} 次请求",
    "usage.monthly": "按月统计",
    "usage.byModel": "按模型统计",
    "usage.model": "模型",
    "usage.requests": "请求数",
    ...
    "usage.cache": "缓存",
    "usage.cost": "费用",
    "usage.footnote": "汇总自 {sessions} 个会话文件；删除会话不会扣减统计，已消耗的用量会保留。费用按会话数据中记录的提供商价格计算，未配置价格的模型显示 $0。",
    "auth.prompt": "登录后继续使用",
    "auth.password": "密码",
    "auth.logIn": "登录",
    "auth.loggingIn": "正在登录...",
    ...
    "sidebar.moveToFolder": "移动到分组…",
    "sidebar.removeFromFolder": "移出分组（恢复工作区默认）",
    "sidebar.deleteFolder": "删除分组",
    "sidebar.archive": "归档会话",
    "sidebar.unarchive": "取消归档",
    "sidebar.archivedCount": "已归档 ({count})",
    "sidebar.hideWorkspace": "从列表隐藏工作区",
    "sidebar.unhideWorkspace": "恢复显示工作区",
    "sidebar.hiddenWorkspaces": "已隐藏的工作区 ({count})",
    "sidebar.cannotHideCurrent": "当前正在使用的工作区不能隐藏",
    ...
    "chat.stop": "停止",
    "chat.disableSound": "关闭完成提示音与桌面弹窗",
    "chat.enableSound": "开启完成提示音与桌面弹窗",
    "chat.enableNotifications": "开启桌面弹窗通知",
    "chat.disableNotifications": "桌面通知已开启（点击发送测试弹窗）",
    "chat.notificationsBlocked": "桌面通知已被浏览器阻止，请在地址栏网站设置中允许",
    "chat.notificationTestTitle": "pi-web 桌面通知已就绪",
    "chat.notificationTestBody": "任务完成或需要输入时将在系统右下角弹出提示",
