...
export const zhTWLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "common.usage": "用量",
    "usage.title": "Token 用量統計",
    "usage.description": "按天與按月統計所有 pi 會話的 Token 消耗，資料來自本機會話檔案。",
    "usage.refresh": "重新整理",
    "usage.refreshing": "重新整理中…",
    "usage.loadError": "載入用量資料失敗：{error}",
    "usage.noData": "尚無用量資料——先開始一段對話吧。",
    "usage.today": "今天",
    "usage.thisMonth": "本月",
    "usage.allTime": "累計",
    "usage.cardSub": "{cost} · {requests} 次請求",
    "usage.tokens": "tokens",
    "usage.dailyActivity": "每日用量",
    "usage.dailyActivityDescription": "過去一年每天一格，點擊某天可查看依模型拆分的明細。",
    "usage.legendLess": "少",
    "usage.legendMore": "多",
    "usage.daySummary": "{tokens} tokens · {cost} · {requests} 次請求",
    "usage.monthly": "按月統計",
    "usage.byModel": "依模型統計",
    "usage.model": "模型",
    "usage.requests": "請求數",
    ...
    "usage.cache": "快取",
    "usage.cost": "費用",
    "usage.footnote": "彙總自 {sessions} 個會話檔案；刪除會話不會扣減統計，已消耗的用量會保留。費用按會話資料中記錄的提供商價格計算，未設定價格的模型顯示 $0。",
    "auth.prompt": "登入後繼續使用",
    "auth.password": "密碼",
    "auth.logIn": "登入",
    "auth.loggingIn": "正在登入...",
    ...
    "sidebar.moveToFolder": "移動至分組…",
    "sidebar.removeFromFolder": "移出分組（恢復工作區預設）",
    "sidebar.deleteFolder": "刪除分組",
    "sidebar.archive": "封存對話",
    "sidebar.unarchive": "取消封存",
    "sidebar.archivedCount": "已封存 ({count})",
    "sidebar.hideWorkspace": "從清單隱藏工作區",
    "sidebar.unhideWorkspace": "恢復顯示工作區",
    "sidebar.hiddenWorkspaces": "已隱藏的工作區 ({count})",
    "sidebar.cannotHideCurrent": "目前使用中的工作區無法隱藏",
    ...
    "chat.stop": "停止",
    "chat.disableSound": "關閉完成提示音與桌面彈窗",
    "chat.enableSound": "開啟完成提示音與桌面彈窗",
    "chat.enableNotifications": "開啟桌面彈窗通知",
    "chat.disableNotifications": "桌面通知已開啟（點擊發送測試彈窗）",
    "chat.notificationsBlocked": "桌面通知已被瀏覽器封鎖，請在網址列網站設定中允許",
    "chat.notificationTestTitle": "pi-web 桌面通知已就緒",
    "chat.notificationTestBody": "任務完成或需要輸入時將在此彈出提示",
