...
export function useAgentSession(opts: UseAgentSessionOptions) {
  ...
  return {
    ...
    handleToolPresetChange, handleTogglePlanMode, handleToggleEditMode, handleThinkingLevelChange, loadTools, loadSlashCommands, setActiveLeafId, setData, setMessages, loadContext,
